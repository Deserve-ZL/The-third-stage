...
import { Table, Popconfirm, Input, Button, Icon, Divider, Modal,DatePicker } from "antd";
import Highlighter from "react-highlight-words";

export default class FormalDemo extends React.Component {
  constructor(props) {
    super(props);
    this.columns = [
      {
      ...
      },
      {
        ...
        key: "developmentday",
        width: 200,
        ...this.getColumnSearchProps("developmentday")
      },
      {
        title: "成为拟发展对象时间",
        dataIndex: "quasiday",
        key: "quasiday",
        width: 200,
        ...this.getColumnSearchProps("quasiday")
      }, {
        title: '成为预备党员时间',
        dataIndex: 'prepareday',
        width: 200,
        key: 'prepareday',
        ...this.getColumnSearchProps("prepareday")
      }, {
        title: '成为拟转正预备党员时间',
        dataIndex: 'quasiformalday',
        width: 200,
        key: 'quasiformalday',
        ...this.getColumnSearchProps("quasiformalday")
      },{
        title: '转正时间',
        dataIndex: 'formalday',
        width: 200,
        key: 'formalday',
        ...this.getColumnSearchProps("formalday")
      },
      {
        title: "操作",
        key: "action",
  ...
  render() {
    ...
    return (
      <div>
        <Button
          onClick={this.formalAdd.bind(this)}
          type="primary"
        ...
        <Modal
          title="Basic Modal"
          centered
          visible={this.state.formalvisible}
          onOk={this.formalOk}
          onCancel={this.formalCancel}
        >
          姓名：<input type="text" />
          年龄：<input type="text" />
          入党申请时间：<DatePicker onChange={this.onChange} /><br /><br /><br /><br /><br /><br /><br />
        </Modal>
        <Table
